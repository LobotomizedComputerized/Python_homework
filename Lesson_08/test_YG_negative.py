...
#________Завершение_сбора_данных_____________________
...
def test_get_list_projects():
    ...
    req_get_list_project = obj_req.get(base_url + "/api-v2/projects", headers = dict_headers_func_3)
...
def test_get_project_by_id():
    ...
    req_get_project_by_id = obj_req.get(base_url + "/api-v2/projects/" + obj_project_id, headers = dict_headers_func_3)
